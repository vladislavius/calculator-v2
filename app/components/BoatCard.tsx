        ...
        <div className="os-boat-card__specs">
          ...
          {isAdmin && boat.chat_url && (
            <a href={boat.chat_url} target="_blank" rel="noopener noreferrer"
              ...
              style={{marginLeft:'auto',fontSize:'18px',textDecoration:'none',lineHeight:1,display:'flex',alignItems:'center'}}
          ...
          {isAdmin && boat.calendar_url && (
            <a href={boat.calendar_url} target="_blank" rel="noopener noreferrer"
              ...
              style={{marginLeft: boat.chat_url ? '4px' : 'auto',fontSize:'17px',textDecoration:'none',lineHeight:1,display:'flex',alignItems:'center'}}
            >📅</a>
          )}
