...
export default function Home() {
  ...
  const generatePDF = () => {
    ...
    const printContent = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Расчёт - ' + selectedBoat.boat_name + '</title><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:Segoe UI,Roboto,Arial,sans-serif;padding:15px 20px;color:#1a1a2e;max-width:100%;margin:0 auto;font-size:11px;background:#fff;line-height:1.4}.header{text-align:center;margin-bottom:12px;padding:12px 15px;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);border-radius:10px;color:white}.logo{font-size:18px;font-weight:800;color:white;margin-bottom:4px;letter-spacing:1px;text-transform:uppercase}.subtitle{color:rgba(255,255,255,0.9);font-size:10px;font-weight:300}.date{color:rgba(255,255,255,0.8);font-size:9px;margin-top:6px;padding-top:6px;border-top:1px solid rgba(255,255,255,0.3)}.yacht-info{background:#f8fafc;border:1px solid #e2e8f0;padding:12px;border-radius:8px;margin-bottom:10px}.yacht-name{font-size:16px;font-weight:700;margin-bottom:8px;color:#1e293b;border-bottom:2px solid #667eea;padding-bottom:6px}.yacht-details{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.yacht-detail-label{font-size:8px;color:#64748b;margin-bottom:2px;text-transform:uppercase;letter-spacing:0.3px}.yacht-detail-value{font-size:11px;font-weight:600;color:#1e293b}.section{margin-bottom:8px;background:#fff;border:1px solid #e2e8f0;border-radius:6px;padding:8px 10px;box-shadow:0 1px 2px rgba(0,0,0,0.03)}.section-title{font-size:10px;font-weight:700;color:#667eea;margin-bottom:6px;padding-bottom:4px;border-bottom:1px solid #667eea;text-transform:uppercase;letter-spacing:0.5px}.included-list{display:flex;flex-wrap:wrap;gap:4px}.included-item{background:linear-gradient(135deg,#d1fae5,#a7f3d0);color:#065f46;padding:3px 8px;border-radius:10px;font-size:9px;font-weight:500}table{width:100%;border-collapse:collapse;margin-top:12px}table{table-layout:fixed}th,td{padding:6px 10px;border-bottom:1px solid #f1f5f9;vertical-align:middle}th:first-child,td:first-child{text-align:left;width:55%}th:nth-child(2),td:nth-child(2){text-align:center;width:20%}th:last-child,td:last-child{text-align:right;width:25%}th{background:linear-gradient(135deg,#f8fafc,#f1f5f9);font-weight:600;color:#475569;font-size:8px;text-transform:uppercase;letter-spacing:0.3px}td:last-child{text-align:right;font-weight:600;color:#1e293b}.total-section{background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:white;padding:12px 15px;border-radius:10px;margin-top:10px;box-shadow:0 4px 15px rgba(102,126,234,0.2);overflow:hidden;page-break-inside:avoid}.total-row{display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid rgba(255,255,255,0.15);font-size:11px}.total-row:last-child{border-bottom:none}.total-row.final{font-size:14px;font-weight:800;margin-top:6px;padding-top:8px;border-top:2px solid rgba(255,255,255,0.4);border-bottom:none}.footer{margin-top:10px;text-align:center;color:#64748b;font-size:9px;padding:8px;background:#f8fafc;border-radius:6px}@media print{body{padding:20px;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;color-adjust:exact!important}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}}</style></head><body>' +
